...
<form method="POST" action="processes/process.user.php?action=update">
        <div id="form-block-half">
            ...
            <select id="access" name="access">
             <option value="Baker" <?php if($user->get_user_access($id) == "Baker"){ echo "selected";};?>>Baker</option>
    ...
    <div class="container">
      ...
      <input type="hidden" id="userid" name="userid" value="<?php echo $id;?>"/>
        <label for="crpassword">Current Password</label>
            ...
            <input type="password" id="npassword" class="input" name="npassword" placeholder="New Password" pattern="^(?=.*[a-z])(?=.*[A-Z])(?=.*\d).*$" title="Password must contain at least one uppercase letter, one lowercase letter, and one number" required>
            <label for="copassword">Confirm Password</label>
            <input type="password" id="copassword" class="input" name="copassword" placeholder="Confirm Password" pattern="^(?=.*[a-z])(?=.*[A-Z])(?=.*\d).*$" title="Password must contain at least one uppercase letter, one lowercase letter, and one number" required>           
       </form> 
      <div class="clearfix">
